...
module.exports = {
    ...
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://www.linkpicture.com/q/Screenshot_20211001-083824_1.jpg' : process.env.GAN_IMAGE,
    LANG: process.env.LANGUAGE === undefined ? 'TR' : process.env.LANGUAGE.toUpperCase(),
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'default' : process.env.ALIVE_MESSAGE,
    KICKMEMSG: process.env.KICKME_MESSAGE === undefined ? 'default' : process.env.KICKME_MESSAGE,
    BLOCKCHAT: process.env.BLOCK_CHAT === undefined ? false : process.env.BLOCK_CHAT,
    WELCOME: process.env.WELCOME === undefined ? 'pp' : process.env.WELCOME,
    OWNER: process.env.OWNER_NAME === undefined ? 'dennisbot' : process.env.OWNER_NAME,
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By Philsmagic✨' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '2348159983206@s.whatsapp.net' : process.env.TAG_REPLY,
